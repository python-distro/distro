...
class LinuxDistribution:
    ...
    def __init__(
        ...
        * :py:exc:`UnicodeError`: A data source has unexpected characters or
        ...
        if os_release_file:
            ...
            if _isfile(etc_dir_os_release_file) or not _isfile(usr_lib_os_release_file):
    ...
    @staticmethod
    def _abs_path_join(root_path: Path, abs_path: Path) -> Path:
        ...
        while True:
            ...
            for i, part in enumerate(relative_parts, start=1):
                if part == os.pardir:
                    ...
                    path_to_resolve = self._abs_path_join(
                        chroot_path,
                ...
                if symlink_resolved.is_absolute():
                    path_to_resolve = self._abs_path_join(chroot_path, symlink_resolved)
                else:
